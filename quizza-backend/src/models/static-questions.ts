...
export const questions: Question[] = [
  ...
  },
  {
    ...
    category: Category.HISTORY,
    question:
      "Which empire was known for its road system and Cornelia's other infrastructures?",
    answers: [
  ...
  },
  {
    ...
    category: Category.STORIES,
    question:
      "Which character is known for enjoying adventures and features in 'The Adventures of Tom Sawyer'?",
    answers: [
  ...
  },
  {
    ...
    category: Category.STORIES,
    question:
      "What is the title of Lewis Carroll's famous poem that begins with 'Twas brillig, and the slithy toves'?",
    answers: [
